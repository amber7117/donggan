...
class MatchStatusBBScoreCellWidget extends StatelessWidget {
      ...
      children: [
        ...
        Container(
          ...
          child: Text(
            ...
            overflow: TextOverflow.ellipsis,
            style: TextStyle(
                color: color1, fontSize: 12, fontWeight: TextStyleUtils.medium),
          ),
        ),
        Container(
          width: statusBBScoreCellWidth,
          ...
          child: Text(
            ...
            overflow: TextOverflow.ellipsis,
            style: TextStyle(
                color: color2, fontSize: 12, fontWeight: TextStyleUtils.medium),
          ),
        ),
      ],
    );
