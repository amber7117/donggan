...
class _JhPulseAnimationViewState extends State<JhPulseAnimationView>
  ...
  _init() {
    ...
    _animation = TweenSequence<double>([
      ...
      TweenSequenceItem(
          tween: Tween(begin: widget.begin, end: widget.end), weight: 1),
      TweenSequenceItem<double>(
          tween: Tween(begin: widget.end, end: 1), weight: 1),
    ]).animate(
