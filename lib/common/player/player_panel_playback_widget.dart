...
FijkPanelWidgetBuilder playbackPanelBuilder(
    {Key? key,
    bool fill = false,
    int animTime = 5000,
    bool doubleTap = true,
...
class _PlayerPanelPlayback extends StatefulWidget {
  ...
  @override
  State createState() => __PlayerPanelPlaybackState();
}

class __PlayerPanelPlaybackState extends State<_PlayerPanelPlayback> {
