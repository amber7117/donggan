...
class _CustomPanelPlayback extends StatefulWidget {
  ...
  @override
  State createState() => __CustomPanelPlaybackState();
}

class __CustomPanelPlaybackState extends State<_CustomPanelPlayback> {
